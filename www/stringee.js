...
!(function(window, undefined) {
  console.log("DA AN VAO FUNCTION TU GOI");

  var StringeeHelpers = function(domId) {
    console.log("DA AN VAO HAM TAO HELPERS");
...
(function(window, StringeeHelpers, undefined) {
  console.log("DA AN VAO FUNCTION TU GOI 2");

  StringeeHelpers.eventing = function(self, syncronous) {
    var _events = {};

    console.log("DA AN VAO eventing");
...
// window.connect = function(name, successCallback, errorCallback) {
//   cordova.exec(successCallback, errorCallback, "StringeePlugin", "connect", [
//     name
//   ]);
// };
